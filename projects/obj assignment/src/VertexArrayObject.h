...
public:
	...
	typedef std::shared_ptr<VertexArrayObject> svaptr;
...
public:
	...
	void SetIndexBuffer(const IndexBuffer::sibptr& ibo);
	//Adds a VBO to this VAO, with the attributes specified
	void AddVertexBuffer(const VertexBuffer::svbptr& vbo, const std::vector<BufferAttribute>& attributes);
...
private:
	...
	{
		VertexBuffer::svbptr vbo;
		std::vector<BufferAttribute> Attributes;
	};

	//The index buffer bound to this VAO
	IndexBuffer::sibptr _ibo;
