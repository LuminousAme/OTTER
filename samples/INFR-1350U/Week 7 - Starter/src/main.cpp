...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Ame Gilham - 100741352 - Tutorial week 7", nullptr, nullptr);
...
int main() {
	...
	Texture2DData::sptr diffuse2Map = Texture2DData::LoadFromFile("images/box.bmp"); 
